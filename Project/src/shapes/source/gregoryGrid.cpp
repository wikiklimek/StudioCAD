...
// ========================================================
// FUNKCJE POMOCNICZE (Bezpieczna matematyka wektorowa)
// ========================================================
inline float DotProd(const Vect3& a, const Vect3& b)
{
    return a.x*b.x + a.y*b.y + a.z*b.z;
}

inline Vect3 CrossProd(const Vect3& a, const Vect3& b)
{
    return Vect3(a.y*b.z - a.z*b.y, a.z*b.x - a.x*b.z, a.x*b.y - a.y*b.x);
}

inline Vect3 NormalizeVec(Vect3 v)
{
    float len = std::sqrt(v.x*v.x + v.y*v.y + v.z*v.z);
    if (len > 1e-6f) return Vect3(v.x/len, v.y/len, v.z/len);
    return Vect3(0,0,0);
}
